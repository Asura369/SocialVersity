    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl w-full">
                {/* Part 1 Card */}
                <Card className="hover:shadow-xl transition-shadow border-primary-100">
                    ...
                    <CardBody className="p-8 flex flex-col items-center text-center">
                        ...
                        <Link to="/v1/landing" className="w-full">
                ...
                {/* Part 2 Card */}
                <Card className="hover:shadow-xl transition-shadow border-secondary-100">
                    ...
                    <CardBody className="p-8 flex flex-col items-center text-center">
                        ...
                        <Link to="/v2/landing" className="w-full">
